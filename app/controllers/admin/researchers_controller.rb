class Admin::ResearchersController < DashboardController
  ...
  def researcher_params
    params.require(:researcher).permit(:active, :first_name, :last_name, :bio, :phone, :email, :address, :image, :remove_image, :title, :visible, :bibliography, :research_project_ids => [], :course_ids => [])
  end
end
